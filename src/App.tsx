...
function App() {
  ...
  const services = [
    ...
    },
    {
      ...
      details: {
        fullDescription:
          "Our Quantum Security solutions provide next-generation protection against both classical and quantum threats, ensuring your data remains secure in the post-quantum era.",
        features: [
